...
- 支持读取当前活动窗口，生成屏幕学习/娱乐/游戏分类摘要。
- 提供基础 tkinter 桌面 UI，可输入问题、查看回复、手动采集摄像头上下文，并按间隔自动监控。
...
本项目按比赛要求通过多个小粒度 PR 持续提交。每个 PR 只实现一个功能点，并在 PR 描述中说明功能描述、实现思路和测试方式。

已完成方向包括：项目初始化、视觉摘要、本地/云端决策、语音与 CLI、测试补充、PR 模板、屏幕感知、云端配置、桌面 UI、自动监控循环等。
